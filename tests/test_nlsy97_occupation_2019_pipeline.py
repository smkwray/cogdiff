...
def test_nlsy97_occupation_2019_coalesces_across_slots(tmp_path: Path) -> None:
...
sample_construct:
  ...
  column_map:
    ...
    R9705200: GS
    R9705300: AR
    U4114400: occupation_code_2019_slot01
    U4114500: occupation_code_2019_slot02
expected_age_range:
  min: 13
  max: 17
""",
    ...
    pd.DataFrame(
        [
            {"R0000100": 1, "R0536300": "F", "R0536402": 1981, "R9705200": 10, "R9705300": 11, "U4114400": 1020, "U4114500": -4},
            {"R0000100": 2, "R0536300": "M", "R0536402": 1982, "R9705200": 12, "R9705300": 13, "U4114400": -4, "U4114500": 3600},
            {"R0000100": 3, "R0536300": "F", "R0536402": 1983, "R9705200": 14, "R9705300": 15, "U4114400": 4210, "U4114500": -4},
        ]
    ...
    for frame in (cfa, resid):
        assert "occupation_code_2019" in frame.columns
    assert set(pd.to_numeric(cfa["occupation_code_2019"], errors="coerce").dropna().astype(int)) == {1020, 3600, 4210}
    assert set(pd.to_numeric(resid["occupation_code_2019"], errors="coerce").dropna().astype(int)) == {1020, 3600, 4210}
