...
def test_nlsy97_occupation_2021_coalesces_across_slots(tmp_path: Path) -> None:
...
sample_construct:
  ...
  column_map:
    ...
    R9705200: GS
    R9705300: AR
    U5591200: occupation_code_2021_slot01
    U5591300: occupation_code_2021_slot02
expected_age_range:
  min: 13
  max: 17
""",
    ...
    pd.DataFrame(
        [
            {"R0000100": 1, "R0536300": "F", "R0536402": 1981, "R9705200": 10, "R9705300": 11, "U5591200": 1020, "U5591300": -4},
            {"R0000100": 2, "R0536300": "M", "R0536402": 1982, "R9705200": 12, "R9705300": 13, "U5591200": -4, "U5591300": 3600},
            {"R0000100": 3, "R0536300": "F", "R0536402": 1983, "R9705200": 14, "R9705300": 15, "U5591200": 4210, "U5591300": -4},
        ]
    ...
    for frame in (cfa, resid):
        assert "occupation_code_2021" in frame.columns
    assert set(pd.to_numeric(cfa["occupation_code_2021"], errors="coerce").dropna().astype(int)) == {1020, 3600, 4210}
    assert set(pd.to_numeric(resid["occupation_code_2021"], errors="coerce").dropna().astype(int)) == {1020, 3600, 4210}
